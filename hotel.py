...
frame = Frame(root,width=650,height=70,relief=RIDGE,borderwidth=5,bg='#ffffff')
frame.place(x=0,y=0)

l1 = Label(frame,text="Hotel Management System",font=('roboto',30,'bold'),bg='#33FF68',fg="#ffffff")
l1.place(x=10,y=4)
...
innerframe3 = Frame(frame2,width=440,height=80,relief=RIDGE,borderwidth=3,bg='#FF3358',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
...
innerframe4 = Frame(frame3,width=190,height=310,relief=RIDGE,borderwidth=3,bg='#33F6FF',highlightbackground="white", highlightcolor="white", highlightthickness=2)        
...
nine = Button(innerframe4,text="9",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=nine)
nine.place(x=0,y=24)
eight = Button(innerframe4,text="8",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=eight)
eight.place(x=48,y=24)
seven = Button(innerframe4,text="7",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=seven)
...
six = Button(innerframe4,text="6",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=six)
six.place(x=0,y=50)
five = Button(innerframe4,text="5",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=five)
five.place(x=48,y=50)
four = Button(innerframe4,text="4",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=four)
...
three = Button(innerframe4,text="3",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=three)
three.place(x=0,y=76)
two = Button(innerframe4,text="2",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=two)
two.place(x=48,y=76)
one = Button(innerframe4,text="1",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=one)
one.place(x=96,y=76)
...
zero = Button(innerframe4,text="0",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=zero)
zero.place(x=0,y=102)
clear = Button(innerframe4,text="C",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=clear)
clear.place(x=48,y=102)
equal = Button(innerframe4,text="=",padx=15,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#A569BD',fg="white",command=equal)
